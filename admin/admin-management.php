...
if (isset($_POST['enable']) || isset($_POST['disable'])) {
    ...
    if (isset($_POST['enable'])) {
        $user2->user_id = $_POST['enable'];
        $status = 1;
    } else {
        $user2->user_id = $_POST['disable'];
        $status = 2;
    }
...
$user = new User();
$userListActive = $user->getDistinctUsersByStatus(1, "admin");
$userListDisable = $user->getDistinctUsersByStatus(2, "admin");
