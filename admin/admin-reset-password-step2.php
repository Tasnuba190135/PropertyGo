...
if (isset($_POST['submit_otp'])) {
    ...
    if ($_POST['otp'] != $otp) {
        ...
        echo '<script> window.location.href = "admin-reset-password-step3.php";</script>';
        exit();
    }
}
...
<hr> -->
                ...
                <input type="password" name="password" id="password" placeholder="Enter your password" required>
                    ...
                    <div class="button-container2">
                        <button class="btn-signup" name="submit_otp" type="submit" role="button">Submit OTP</button>
                    </div>
                </form>
