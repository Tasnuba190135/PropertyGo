...
auth('admin'); // Check if the user is logged in as a super admin admin
...
$user = new User();
$userList = $user->getDistinctUsersByStatus(0, "admin"); // Get all users with status 0 (pending)
                        ...
                        <tbody>
                            ...
                            if ($userList && count($userList) > 0) {
                                foreach ($userList as $userItem) {
                                    ...
                                    // Create a new instance of UserDetails and set value for this user
